...
define([
	...
	$('#newBtn').on('click',function(){
		   ...
		   var aef = new App.Views.ApplicationEditForm();  //по умолчанию показана
		}			
	);
	...
	$('#delBtn').on('click',function(){	   
		...
		var adlf = new App.Views.ApplicationDeleteForm();  //по умолчанию спрятана
		}			
	);		
	...
	$('#applicationmode').on('click',function(){	
		 app.casheedtrecords.reset();
		 app.casheedtrecords = new App.Collections.Applications();
		 $('#mainGridPlace').empty(); 
		 app.datastate = 'data';
		 app.cc = new App.Views.CUDControl({collection: app.applications});			
		 app.mpg = new App.Views.ApplicationPagGrid({collection: app.applications, parentpaggrid: '#mainGridPlace'});			
		}			
	);
